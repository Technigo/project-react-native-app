...
export const Home = ({ navigation }) => {
  return (
    <HomeContainer>
      <Text>Hi there! Lookin´ for advice in life? Or perhaps just want someone to make a desicion for you? Or maybe just for Chuck Norris to cheer you up by simply being...Chuck Norris?</Text>
