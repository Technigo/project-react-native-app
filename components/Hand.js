            ...
            <ScrollView>
                ...
                <ViewContainer>
                    <BackgroundImageContainer source={BackgroundImage} resizeMode={"contain"}>
                        <QuoteContainer>
                            <QuoteText>"The only courage you ever need is the courage to fulfill the dreams of your own life"</QuoteText>
                            <AuthorText>- OPRAH -</AuthorText>
                        </QuoteContainer>
